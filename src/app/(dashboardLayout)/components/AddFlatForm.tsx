...
export function AddFlatForm() {
  ...
  const form = useForm<FlatFormData>({
    defaultValues: {
      ...
      totalBedrooms: 3,
      totalRooms: 5,
      utilitiesDescription: "Water, electricity, and internet included",
      location: "Downtown City Center",
      description:
        "A spacious and modern flat located in the heart of the city, close to all amenities and public transport.",
      rent: 1500,
      availability: true,
      advanceAmount: 500,
    },
